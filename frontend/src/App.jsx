    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/login" element={<LaunchGate />} />
          ...
          <Route path="/admin" element={<ProtectedRoute roles={[1]}><AdminLayout /></ProtectedRoute>}>
            ...
            <Route path="reports" element={<AdminReports />} /><Route path="analytics" element={<Analytics />} /><Route path="notifications" element={<AdminUtility kind="notifications" />} /><Route path="profile" element={<AdminUtility kind="profile" />} /><Route path="settings" element={<AdminUtility kind="settings" />} />
          </Route>
          ...
          <Route path="/analytics" element={<ProtectedRoute roles={[1]}><AdminLayout /></ProtectedRoute>}><Route index element={<Analytics />} /></Route>
